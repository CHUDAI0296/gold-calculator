...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    '黄金计算器','黄金价格','现货金价','克拉含金量','金条重量','熔融价值','克鲁格金币','技术指标','枢轴点','十年金价','美元指数','实际收益率'
  ]
}
